  ...
  <v-flex>
    <v-expansion-panel accordion>
        ...
        <v-flex offset-lg1 class="scrollable">
          <v-layout column>
            ...
            <v-layout>
              ...
              <v-flex>{{resource.certificateIssuerOrganizationUnitName}}</v-flex>
            </v-layout>
            <v-layout>
            ...
            <v-layout>
              ...
              <v-flex>{{resource.certificateSubjectOrganizationUnitName}}</v-flex>
            </v-layout>
            <v-layout>
      ...
      <v-expansion-panel-content>
        ...
        <v-flex offset-lg1 class="scrollable">
          <v-flex class="subtitle-1" v-for="premission in resource.permissionName" :key="premission">{{premission}}</v-flex>
        </v-flex>
      </v-expansion-panel-content>
      <v-expansion-panel-content>
        <template v-slot:header>
        ...
        <v-flex offset-lg1 class="scrollable">
          <v-flex class="subtitle-1" v-for="link in resource.links" :key="link"><a v-bind:href="link">{{link}}</a></v-flex>
        </v-flex>
      </v-expansion-panel-content>
      <v-expansion-panel-content>
        <template v-slot:header>
      ...
      <v-expansion-panel-content>
        ...
        <v-flex offset-lg1 class="scrollable">
          <v-flex class="subtitle-1" v-for="uri in resource.URIDomains" :key="uri"><a v-bind:href="uri">{{uri}}</a></v-flex>
        </v-flex>
      </v-expansion-panel-content>
      <v-expansion-panel-content>
        <template v-slot:header>
...
export default {
  ...
  computed: {
    resource: function() {
      ...
      run_prettify.setAttribute('src', 'https://cdn.rawgit.com/google/code-prettify/master/loader/run_prettify.js');
