    ...
    <v-expansion-panel accordion>
      <v-expansion-panel-content>
        ...
        <v-flex offset-lg1 class="scrollable">
          <v-layout column>
            ...
            <v-layout>
              <v-flex lg4 class="font-weight-bold subtitle-1"
                >Market Size:</v-flex
              >
      ...
      <v-expansion-panel-content>
        ...
        <v-flex offset-lg1 class="scrollable">
          <v-layout column>
            ...
            <v-layout>
              ...
              <v-flex>
                <v-textarea
                  no-resize
                  rows="4"
                  :value="resource.certificatePublicKey"
                  solo
                  readonly
                ></v-textarea>
              </v-flex>
            ...
            <v-layout>
              <v-flex lg4 class="font-weight-bold subtitle-1"
                >Public Key Info:</v-flex
              >
              <v-flex>{{ resource.certificatePublicKeyInfo }}</v-flex>
            </v-layout>
            <v-layout>
              <v-flex lg4 class="font-weight-bold subtitle-1"
                >Signature Algorithm:</v-flex
              >
            ...
            <v-layout>
              <v-flex lg4 class="font-weight-bold subtitle-1"
                >Validity Gap Seconds:</v-flex
              >
              <v-flex>{{ resource.certificateValidityGapSeconds }}</v-flex>
            </v-layout>
            <v-layout>
              <v-flex lg4 class="font-weight-bold subtitle-1"
                >Validity Gap Rounded Years:</v-flex
              >
      ...
      <v-expansion-panel-content>
        ...
        <v-flex offset-lg1 class="scrollable">
          <v-flex class="subtitle-1" v-for="link in resource.links" :key="link"
            ><a v-bind:href="link">{{ link }}</a></v-flex
          >
        </v-flex>
      </v-expansion-panel-content>
      <v-expansion-panel-content>
        ...
        <v-flex offset-lg1 class="scrollable">
          <v-flex
            class="subtitle-1"
            v-for="email in resource.emailDomains"
            :key="email"
            >{{ email }}</v-flex
          >
        </v-flex>
      ...
      <v-expansion-panel-content>
        ...
        <v-flex offset-lg1 class="scrollable">
          <v-flex
            class="subtitle-1"
            v-for="uri in resource.URIDomains"
            :key="uri"
            ><a v-bind:href="uri">{{ uri }}</a></v-flex
          >
        </v-flex>
      </v-expansion-panel-content>
      <v-expansion-panel-content>
        ...
        <v-flex class="scrollable">
          <pre
            pre
            class="prettyprint"
          ><code class="language-xml">{{code}}</code></pre>
        </v-flex>
      </v-expansion-panel-content>
    </v-expansion-panel>
  </v-flex>
...
export default {
  ...
  data: function() {
    return {
      code: formatXml(this.plugin_data.results.androidXMLManifest)
    };
  },
  computed: {
    resource: function() {
